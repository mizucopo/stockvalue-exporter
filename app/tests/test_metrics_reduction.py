...
class TestMetricsReduction:
    ...
    def test_range_metrics_disabled(self):
        ...
        factory = MetricsFactory.create_default(registry=registry, app_config=mock_config)
        all_metrics = factory.get_all_metrics()
        
        # 52週系メトリクス（8個）が削除されることを確認
        range_metrics = [
            "stock_52week_high", "stock_52week_low",
            "forex_52week_high", "forex_52week_low", 
            "index_52week_high", "index_52week_low",
            "crypto_52week_high", "crypto_52week_low"
        ]
    ...
    def test_debug_metrics_disabled(self):
        ...
        debug_metrics = [
            "stock_fetch_duration", "stock_fetch_errors",
            "forex_fetch_duration", "forex_fetch_errors",
            "index_fetch_duration", "index_fetch_errors", 
            "crypto_fetch_duration", "crypto_fetch_errors"
        ]
    ...
    def test_both_metrics_disabled(self):
        ...
        core_metrics = [
            ...
            "forex_rate", "index_value", "crypto_price"
        ]
    ...
    def test_metrics_reduction_impact(self):
        ...
        full_factory = MetricsFactory.create_default(registry=full_registry, app_config=full_config)
        ...
        reduced_factory = MetricsFactory.create_default(registry=reduced_registry, app_config=reduced_config)
